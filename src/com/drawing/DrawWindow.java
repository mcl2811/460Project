...
public class DrawWindow extends Frame implements KeyListener, MouseListener {
	...
	final public String TITLE = "Miguel Carrera Lorenzo Project"; // window's title
	final public int FPS = 60; // animator's target frames per second
	...
	public void mouseReleased(MouseEvent e) {
		...
		if (e != null) {
			mouse.setPressReleaseStatus(true);
			mouse.setPointClicked(e.getPoint());
			((GLUTCanvas) canvas).processMouseEvents();
			mouse.setPressReleaseStatus(false);
