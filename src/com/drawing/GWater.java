...
public class GWater implements GShape, Comparable<GWater> {
	...
	GWater(final GL2 gl, float vertex2f[]) {
	...
	public void reloadThings(final GL2 gl, boolean resetPosFlag) {
		...
		String textureName = "/world/forest/Tiles/17.png";
	...
	public void render(final GL2 gl) {
		...
		if (vertex2f[3] < -(GLUTCanvas.DRAWING_WIDTH / 2 + this.getWidth() +500)) {
	...
	public int compareTo(GWater paramRect) {
